...
public class ServiceClientIT extends MethodNameLoggingIntegrationTest
{
    ...
    {
        connectionString = retrieveEnvironmentVariableValue(connectionStringEnvVarName);
    ...
    public void cloudToDeviceTelemetry() throws Exception
    {
        ...
        ServiceClient serviceClient = ServiceClient.createFromConnectionString(connectionString, testInstance.protocol);
